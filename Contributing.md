...
Before reporting a bug, please make sure you have searched the [issues](https://github.com/KGuz/chessie/issues) to see if it has already been reported. If it hasn't, please create a new issue.
...
Before suggesting an enhancement, please make sure you have searched the [issues](https://github.com/KGuz/chessie/issues) to see if it has already been suggested. If it hasn't, please create a new issue.
...
By contributing to this project, you agree that your contributions will be licensed under the [MIT License](https://github.com/KGuz/chessie/blob/main/License.md).
